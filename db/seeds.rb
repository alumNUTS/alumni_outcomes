...
Survey.create([
  ...
  {name: 'Mark Paulson', web_dev_type: 1, employment_status: 'false', enough_preparation: 3, officer_effectiveness: 2, should_have_learned: 'The skills we learned were relevant.', hurdles: 'My biggest hurdle is the fact that I was only going for start-up jobs but now I\ll start going for mid-size companies next.', anything_else: 'Guess you\ll be seeing more of me around campus getting some more leads.', cohort_id: 1},
  {name: 'Clint Johnson', web_dev_type: 2, employment_status: 'false', enough_preparation: 1, officer_effectiveness: 2, should_have_learned: 'I dunno why I can\t find a job. Been looking for 3 months now.', hurdles: 'I went to London for a few weeks and finally got back on track with my job hunt.', anything_else: '', cohort_id: 2},
  {name: 'Joe Lemming', web_dev_type: 3, employment_status: 'true', position_type: 1, found_thru_outcomes: 'false', company: 'Poppin', employment_date: Date.parse('2014/07/04'), enough_preparation: 4, officer_effectiveness: 2, should_have_learned: 'Wanted to spend more time on front-end frameworks.', anything_else: 'My officer was helpful but ultimately I found a job on my own.', cohort_id: 2},
  {name: 'Orin Xie', web_dev_type: 3, employment_status: 'true', position_type: 2, found_thru_outcomes: 'true', company: 'Chase Bank', employment_date: Date.parse('2014/09/22'), enough_preparation: 5, officer_effectiveness: 3, should_have_learned: 'Seems like we learned a lot of what I\m using on the job right now.', anything_else: 'I\ve already turned on a couple of people to this course.', cohort_id: 1},
  {name: 'Candice Metcalfe', web_dev_type: 3, employment_status: 'true', position_type: 1, found_thru_outcomes: 'true', company: 'Google', employment_date: Date.parse('2014/12/10'), enough_preparation: 5, officer_effectiveness: 3, should_have_learned: 'No real comment because I went for a ruby job and got it on the spot.',  anything_else: 'Thanks for everything, guys.', cohort_id: 2},
  {web_dev_type: 2, employment_status: 'true', position_type: 2, found_thru_outcomes: 'true', company: 'Dept of Labor', employment_date: Date.parse('2014/09/01'), enough_preparation: 5, officer_effectiveness: 2, should_have_learned: 'PHP and Python', cohort_id: 1},
  {name: 'James Jones', web_dev_type: 3, employment_status: 'false',  enough_preparation: 1, officer_effectiveness: 1, should_have_learned: 'This course was tough but I feel like we learned TOO many things in a short amount of time.', hurdles: 'Everything', cohort_id: 2},
  {name: 'Lee Cremini', web_dev_type: 1, employment_status: 'false', enough_preparation: 1, officer_effectiveness: 2, should_have_learned: 'Wanted more time on CSS', hurdles: 'Maybe my Linkedin profile?????', cohort_id: 2},
  {name: 'Brenda Chairish', web_dev_type: 2, employment_status: 'true', position_type: 1, found_thru_outcomes: 'true', company: 'Games, Games, and More Games', employment_date: Date.parse('2014/10/01'), enough_preparation: 4, officer_effectiveness: 3, should_have_learned: 'Drupul would have been great but am learning it on the job anyway', cohort_id: 2},
  {name: 'Max Ergason', web_dev_type: 3, employment_status: 'true', position_type: 1, found_thru_outcomes: 'true', company: 'General Assembly', employment_date: Date.parse('2015/09/24'), enough_preparation: 5, officer_effectiveness: 3, should_have_learned: 'Totally relevant curriculum!', cohort_id: 3},
  {name: 'Domenica LaLima', web_dev_type: 2, employment_status: 'true', position_type: 2, found_thru_outcomes: 'false', company: 'Gilt', employment_date: Date.parse('2014/12/31'), enough_preparation: 3, officer_effectiveness: 3, should_have_learned: 'I recommend teaching more frameworks cuz they totally streamline the workflow.', anything_else: 'Even though I found my job on my own, it wouldn\t have been possible w/out a great LinkedIn profile...thanks to GA!', cohort_id: 1}
